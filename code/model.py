...
class ContrastiveLoss(nn.Module):
    ...
    def rank_loss(self, scores, image_cider, caption_cider):
    ...
    def forward(self, scores, image_cider, caption_cider):
        ...
        loss2 = self.rank_loss(scores, image_cider, caption_cider)
        return loss1, loss2
...
class SGRAF(object):
    ...
    def forward_loss(self, sims, image_cider, caption_cider, **kwargs):
        ...
        """
        triplet_loss, rank_loss = self.criterion(sims, image_cider, caption_cider)
        ...
        self.logger.update('Rank_loss', rank_loss.item(), sims.size(0))
        return loss, triplet_loss, rank_loss
    ...
    def train_emb(self, images, captions, lengths, ids=None, tfidf_for_caption=None, tfidf_for_image=None, *args):
        ...
        sims = self.forward_sim(img_embs, cap_embs, cap_lens) #regions-words similarity matrix [128, 128]
        #compute CIDErs
